...
class EspacioController extends Controller {
	...
	public function individualAction($id) {
        ...
        $object = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Espacio') -> find($id);
        $reservas = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Reserva') -> findByEspacio($object);
		...
		return $this -> render('ProjectFrontBundle:Espacio:individual.html.twig', $array);
	}
	public function grupalAction() {
		...
		$array = array_merge($firstArray, $secondArray);
		return $this -> render('ProjectFrontBundle:Espacio:grupal.html.twig', $array);
	}
	...
	public static function registrarEditar($id ,$url,Request $request,$class) {
		...
		else $object = $class -> getDoctrine() -> getRepository('ProjectBackBundle:Espacio') -> find($id);
		...
		return $class -> render('ProjectFrontBundle:Espacio:registrarEditar.html.twig', $array);
	}
    public function destacadosAction($numResults)
    {
        ...
        $dql =  'SELECT o1.id,o1.nombre,o1.path, o1.superficie,o1.precioPorHora,o2.nombre localidad
                 FROM ProjectBackBundle:Espacio o1, ProjectBackBundle:Localidad o2 WHERE o1.localidad = o2.id and o1.destacado = 1 ORDER BY o1.id ASC';
        ...
        return $this->render('ProjectFrontBundle:Espacio:destacados.html.twig', $arreglo);
    }
    public function widgetAction($titulo,$numResults,$paginacion,$proveedor,$cliente,$idRelacionado)
    {
        ...
        $dql =  'SELECT COUNT(o1.id) c,o2.id,o2.nombre 
                 FROM ProjectBackBundle:Espacio o1, 
        ...
        return $this->render('ProjectFrontBundle:Espacio:widget.html.twig', $arreglo);
    }
    ...
    $dqlTotales =  'SELECT DISTINCT COUNT(DISTINCT o1.id) FROM ProjectBackBundle:Espacio o1 ';
    ...
    if($parametros!=null){
        ...
        if($parametros['disponibilidad']!= null && $parametros['disponibilidad']!=0){
            ...
            $dql.= ' o1.id NOT IN ( SELECT DISTINCT s1.id FROM ProjectBackBundle:Espacio s1, ProjectBackBundle:Reserva s3 WHERE s1.id = s3.espacio and s3.fechaInicio BETWEEN  :fechaInicio AND :fechaFin  or  s3.fechaFin BETWEEN  :fechaInicio AND :fechaFin AND s1.id = s3.espacio ) ';
            $dqlTotales.= ' o1.id NOT IN ( SELECT DISTINCT s1.id FROM ProjectBackBundle:Espacio s1, ProjectBackBundle:Reserva s3 WHERE s1.id = s3.espacio and s3.fechaInicio BETWEEN  :fechaInicio AND :fechaFin or s3.fechaFin BETWEEN  :fechaInicio AND :fechaFin AND s1.id = s3.espacio  ) ';
    ...
    if($cliente){
        ...
        $dql.= ' o1.id IN ( SELECT DISTINCT r2.id FROM ProjectBackBundle:Reserva r1, 
            ProjectBackBundle:Espacio r2, ProjectUserBundle:User r3 WHERE r1.espacio = r2.id and r1.user = r3.id and r3.id = :idRelacionado ) ';
    ...
    public function reservaAction($id) {
        ...
        return $this -> render('ProjectFrontBundle:Espacio:reserva.html.twig', $array);
    }
    ...
    public function confirmacionAction($id){
        ...
        return $this -> render('ProjectFrontBundle:Espacio:confirmacion.html.twig', $array);
    }
