...
class GestionController extends Controller {
	...
	public function ingresosAction(Request $request) {
        ...
        return $this->render('ProjectBackBundle:Gestion:ingresos.html.twig', $array);
    }
    public function usuariosAction(Request $request) {
        ...
        $array = array_merge($firstArray, $secondArray);
        return $this->render('ProjectBackBundle:Gestion:usuarios.html.twig', $array);
    ...
    public function espaciosAction(Request $request) {
        ...
        $array = array_merge($firstArray, $secondArray);
        return $this->render('ProjectBackBundle:Gestion:espacios.html.twig', $array);
    ...
    public function eventosAction(Request $request) {
        ...
        $array = array_merge($firstArray, $secondArray);
        return $this->render('ProjectBackBundle:Gestion:eventos.html.twig', $array);
    ...
    public function serviciosAction(Request $request) {
        ...
        $array = array_merge($firstArray, $secondArray);
        return $this->render('ProjectBackBundle:Gestion:servicios.html.twig', $array);
    ...
    public function sedesAction(Request $request) {
        ...
        $array = array_merge($firstArray, $secondArray);
        return $this->render('ProjectBackBundle:Gestion:sedes.html.twig', $array);
