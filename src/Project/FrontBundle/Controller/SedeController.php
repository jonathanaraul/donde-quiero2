...
class SedeController extends Controller {
	...
	public function individualAction($id) {
        ...
        $object = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Sede') -> find($id);
        $reservas = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Reserva') -> findBySede($object);
        $sedes = array($object);
		...
		return $this -> render('ProjectFrontBundle:Sede:individual.html.twig', $array);
	}
	public function grupalAction() {
		...
		$array = array_merge($firstArray, $secondArray);
		return $this -> render('ProjectFrontBundle:Sede:grupal.html.twig', $array);
	}
	...
	public static function registrarEditar($id ,$url,Request $request,$class) {
		...
		else $object = $class -> getDoctrine() -> getRepository('ProjectBackBundle:Sede') -> find($id);
		...
		$array = array_merge($firstArray, $secondArray);
		return $class -> render('ProjectFrontBundle:Sede:registrarEditar.html.twig', $array);
	}
    ...
    public function widgetAction($titulo,$numResults,$proveedor,$cliente,$idRelacionado)
    {
        ...
        return $this->render('ProjectFrontBundle:Sede:widget.html.twig', $secondArray);
    }
...
$arreglo = SedeController::consultaBusqueda($parametros);
    ...
    $dql =  'SELECT o1.id,o1.nombre,o1.path, o1.latitud,o1.longitud,o2.nombre localidad
                 FROM ProjectBackBundle:Sede o1, ProjectBackBundle:Localidad o2 ';

    $dqlTotales =  'SELECT COUNT(o1.id) FROM ProjectBackBundle:Sede o1 ';
