...
class ServicioController extends Controller {
	...
	public function individualAction($id) {
        ...
        $object = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Servicio') -> find($id);
        $reservas = $this -> getDoctrine() -> getRepository('ProjectBackBundle:Reserva') -> findByServicio($object);
		...
		return $this -> render('ProjectFrontBundle:Servicio:individual.html.twig', $array);
	}
	public function grupalAction() {
		...
		$array = array_merge($firstArray, $secondArray);
		return $this -> render('ProjectFrontBundle:Servicio:grupal.html.twig', $array);
	}
	...
	public static function registrarEditar($id ,$url,Request $request,$class) {
		...
		else $object = $class -> getDoctrine() -> getRepository('ProjectBackBundle:Servicio') -> find($id);
		...
		$array = array_merge($firstArray, $secondArray);
		return $class -> render('ProjectFrontBundle:Servicio:registrarEditar.html.twig', $array);
	}
    public function destacadosAction($numResults)
    {
        ...
        $dql =  'SELECT o1.id,o1.nombre,o1.path,o1.precioPorHora FROM ProjectBackBundle:Servicio o1  WHERE o1.destacado = 1 
                 ORDER BY o1.id ASC';
        ...
        return $this->render('ProjectFrontBundle:Servicio:destacados.html.twig', $arreglo);
    }
    public function widgetAction($titulo,$numResults,$paginacion,$proveedor,$cliente,$idRelacionado)
    {
        ...
        return $this->render('ProjectFrontBundle:Servicio:widget.html.twig', $arreglo);
    }
    ...
    public function busquedaAction() {
        ...
        $htmlElementos = $this -> renderView('ProjectFrontBundle:Servicio:elementos.html.twig', array('elementos'=>$arreglo['elementos']) );
        $htmlPaginacion = $this -> renderView('ProjectFrontBundle:Servicio:paginacion.html.twig', array('dataPaginacion'=>$arreglo['dataPaginacion']));
    ...
    $dql =  'SELECT o1.id,o1.nombre,o1.path,o1.precioPorHora FROM ProjectBackBundle:Servicio o1';
    $dqlTotales =  'SELECT COUNT(o1.id) FROM ProjectBackBundle:Servicio o1 ';
    ...
    if($cliente){
        ...
        $dql.= ' o1.id IN ( SELECT DISTINCT r2.id FROM ProjectBackBundle:Reserva r1, 
            ProjectBackBundle:Servicio r2, ProjectUserBundle:User r3 WHERE r1.servicio = r2.id and r1.user = r3.id and r3.id = :idRelacionado ) ';
    ...
    public function reservaAction($id) {
        ...
        return $this -> render('ProjectFrontBundle:Servicio:reserva.html.twig', $array);
    }
    ...
    public function confirmacionAction($id){
        ...
        return $this -> render('ProjectFrontBundle:Servicio:confirmacion.html.twig', $array);
    }
}
