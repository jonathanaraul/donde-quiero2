 ...
 * @ORM\Entity(repositoryClass="Project\BackBundle\Entity\LocalidadRepository")
 * @ORM\Entity
 */
class Localidad
{
     ...
     * @return Localidad
     */
    public function setProvincia(\Project\BackBundle\Entity\Provincia $provincia = null)
    {
