 ...
 *
 * @ORM\Table(name="sede")
 * @ORM\Entity(repositoryClass="Project\BackBundle\Entity\SedeRepository")
...
class Sede
{
  ...
  /**
     ...
     * Add espacios
     *
     * @param \Project\BackBundle\Entity\Espacio $espacios
     * @return Sede
     */
    public function addEspacio(\Project\BackBundle\Entity\Espacio $espacios)
    {
     ...
     * @param \Project\BackBundle\Entity\Espacio $espacios
     */
    public function removeEspacio(\Project\BackBundle\Entity\Espacio $espacios)
    {
