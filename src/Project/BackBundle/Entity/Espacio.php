 ...
 * @ORM\Entity(repositoryClass="Project\BackBundle\Entity\EspacioRepository")
...
class Espacio
{
   ...
   /**
     ...
     * @return Espacio
     */
    public function setProjectrPantallaSala($proyectorPantallaSala)
    {
     ...
     * @return boolean 
     */
    public function getProjectrPantallaSala()
    {
