...
class RegistrationController extends BaseController
{
    ...
    public function checkEmailAction()
    {
        ...
        //RegistrationController::enviaMail($user,$this);
    ...
    public static function enviaMail($user,$class){
        $genero = 'Masculino';
        if($user->getSexo() == 0) $genero = 'Femenino';
        $para      = 'jonathan.araul@gmail.com';
        $titulo = 'Nuevo Usuario '.$user->getId();
        $mensaje = 'Se registro '.$user->getUsername().' sus datos son Nombre: '.$user->getName().' Apellido: '
        .$user->getApellido().' Sexo: '.$genero;

        //.' Email: '.$user->getEmail().' Profesion o Area Estudio: '.$user->getProfesionAreaEstudio().' Descripcion: '.$user->getDescripcion();
